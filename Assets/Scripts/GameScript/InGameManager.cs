...
public class InGameManager : MonoBehaviourPunCallbacks
{
    ...
    void Summon(string type)
    {
        ...
        {
            case "_U":
                obj = PhotonNetwork.Instantiate("Character/Epic/Sasha_E", new Vector3(tmp.position.x + UnityEngine.Random.Range(-10, 10), 5, tmp.position.z + UnityEngine.Random.Range(-10, 10)), tmp.rotation);
                obj.transform.SetParent(MyCharacter.transform);
                //obj.name = type;
                break;
            case "_R":
