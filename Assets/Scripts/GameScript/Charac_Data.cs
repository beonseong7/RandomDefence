...
public class Charac_Data
{
    ...
    public void Set_Status()
    {
        ...
        Charac_status["Warload"] = new CharacData("Warload", 0.0f, basicType.Ranged, 10.0f, 4.0f, new SkillData[] { new SkillData("Arrow", skillType.Physical, 0.0f, 10.0f) });
        Charac_status["Holyknight"] = new CharacData("Holyknight", 0.0f, basicType.Melee, 20.0f, 4.0f, new SkillData[] { new SkillData("Arrow", skillType.Physical, 0.0f, 10.0f) });
